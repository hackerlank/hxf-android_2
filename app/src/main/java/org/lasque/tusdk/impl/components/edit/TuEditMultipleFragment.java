...
public class TuEditMultipleFragment extends TuEditMultipleFragmentBase
{
	...
	protected void onPermissionGrantedResult(boolean permissionGranted)
	{
		...
		{
			String msg = TuSdkContext.getString("lsq_edit_no_access", ContextUtils.getAppName(getActivity()));
			
			TuSdkViewHelper.alert(permissionAlertDelegate, getActivity(), TuSdkContext.getString("lsq_edit_alert_title"),
