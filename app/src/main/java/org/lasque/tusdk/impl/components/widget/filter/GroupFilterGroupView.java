...
public class GroupFilterGroupView extends GroupFilterGroupViewBase
{
    ...
    protected void handleTypeGroup(GroupFilterItem model)
    {
        ...
        this.setTextViewText(this.getTitleView(), TuSdkContext.getString(model.filterGroup.getNameKey()));
    ...
    protected void handleTypeFilter(GroupFilterItem model)
    {
        ...
        this.setTextViewText(this.getTitleView(), TuSdkContext.getString(model.filterOption.getNameKey()));
