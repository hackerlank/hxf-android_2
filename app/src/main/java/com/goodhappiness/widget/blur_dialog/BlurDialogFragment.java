package com.goodhappiness.widget.blur_dialog;
...
public abstract class BlurDialogFragment extends DialogFragment {
	...
	public void onStart() {
		...
		if (dialog != null) {
			...
			// add default fade to the dialog if no window animation has been
			// set.
	 ...
	 * <p/>
	 * The factor down scaled factor used to reduce the size of the source
	 * image. Range : ]1.0,infinity)
	 * 
	 ...
	 * Disable by default.
	 * <p/>
	 * Don't forget to add those lines to your build.gradle if your are using
	 * Renderscript
	 * 
	 * <pre>
	 *  defaultConfig {
