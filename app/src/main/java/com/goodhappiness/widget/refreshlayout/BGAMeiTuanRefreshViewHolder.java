...
package com.goodhappiness.widget.refreshlayout;
...
public class BGAMeiTuanRefreshViewHolder extends BGARefreshViewHolder {
    ...
    public BGAMeiTuanRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        ...
        mPullDownImageResId = R.mipmap.dropdown_anim_04;
        mChangeToReleaseRefreshAnimResId = R.drawable.bga_refresh_mt_change_to_release_refresh;
        mRefreshingAnimResId = R.drawable.bga_refresh_mt_refreshing;
    }
