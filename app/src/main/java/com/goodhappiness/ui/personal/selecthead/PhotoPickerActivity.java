...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
    ...
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd(getString(R.string.select_pic));
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart(getString(R.string.select_pic));
    ...
    private void initView() {
        ...
        ll = (LinearLayout) findViewById(R.id.photo_picker_ll);
    ...
    private void getPhotosSuccess() {
        ...
        int i = 0;
        for (Photo p : mPhotoLists) {
            Log.e("ph" + (i++), p.getPath());
        }
    ...
    private void returnData() {
        if (mJumpMode == JUMP_MODE_SELECT_HEAD) {
            Intent intent = new Intent(this, ShowImageStep2Activity.class);
            intent.putExtra("img_path", mSelectList.get(0));
            intent.putExtra("is_camera", isCamera);
