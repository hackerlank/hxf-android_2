...
public class FlowerSendListFragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate{
    @ViewInject(R.id.srl)
    ...
    public FlowerSendListFragment() {
        super(R.layout.fragment_flower_list);
    }

    // TODO: Rename and change types and number of parameters
    public static FlowerSendListFragment newInstance(String param1) {
        FlowerSendListFragment fragment = new FlowerSendListFragment();
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart(getResString(R.string.flower_send_record)); //统计页面，"MainScreen"为页面名称，可自定义
    }
    @Override
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd(getResString(R.string.flower_send_record));
    }
    @Override
    ...
    protected void setData() {
        ...
        adapter = new CommonAdapter<FlowerList.ListBean>(getActivity(),list,R.layout.layout_list_flower_send) {
            @Override
