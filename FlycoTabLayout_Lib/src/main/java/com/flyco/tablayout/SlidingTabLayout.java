...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private GradientDrawable mIndicatorDrawableBottom = new GradientDrawable();
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mCustom = ta.getBoolean(R.styleable.SlidingTabLayout_tl_custom, false);
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mIndicatorGravity == Gravity.BOTTOM) {
                    if(mCustom){
                        mIndicatorDrawableBottom.setColor(mUnderlineColor);
                        mIndicatorDrawableBottom.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
                                height - 2 - (int) mIndicatorMarginBottom,
                                paddingLeft + mIndicatorRect.right - (int) mIndicatorMarginRight,
                                height - (int) mIndicatorMarginBottom);
                        mIndicatorDrawableBottom.setCornerRadius(mIndicatorCornerRadius);
                        mIndicatorDrawableBottom.draw(canvas);
                        mIndicatorDrawable.setColor(mTextSelectColor);
                        mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
                                height - 1 - (int) mIndicatorMarginBottom,
                                paddingLeft + mIndicatorRect.right - (int) mIndicatorMarginRight,
                                height - (int) mIndicatorMarginBottom);
